	    			...
	    			dao.deleteList(listToDelete);
	    			     ...
	    			     getServletContext().getRequestDispatcher("/viewAllListsServlet").forward(request, response);
	    			          ...
	    			          try {
	    			        	  ...
	    			        	  listToEdit.getDateCreated().getMonthValue());
	    			        	  request.setAttribute("date",
	    			        	  listToEdit.getDateCreated().getDayOfMonth());
	    			        	  request.setAttribute("year",
	    			        	  listToEdit.getDateCreated().getYear());
	    			        	  CarInfoHelper daoForItems = new CarInfoHelper();
